...
const topic = 'iot/devices/lights'
const log = 'iot/logs'
...
class LightsFaker{
    ...
    doWork(msg){
        ...
        const message = `Lights : ${this.power}`
...
module.exports.LightsFaker = LightsFaker
