...
const topic = 'iot/devices/sprinkler'
const log = 'iot/logs'
...
class SprinklerFaker{
    constructor(){
      ...
      this.client.on("connect",function(){
          console.log(' *** SprinklerFaker ready! ***')
          this.connected = true
      }.bind(this))
          ...
          .then(function (conn) {
            return conn
              ...
              .then(function (channel) {
                ...
                //   console.log('SprinklerFaker ' + msg)
    ...
    doWork(msg){
        ...
        const message = `Sprinkler : ${this.power}`
...
module.exports.SprinklerFaker = SprinklerFaker
