...
const topic = 'iot/devices/cooling'
const log = 'iot/logs'
...
class CoolingFaker{
    constructor(){
      ...
      this.client.on("connect",function(){
          console.log(' *** CoolingFaker ready! ***')
          this.connected = true
      }.bind(this))
    ...
    doWork(msg){
        ...
        const message = `Cooling : ${this.power}`
...
module.exports.CoolingFaker = CoolingFaker
